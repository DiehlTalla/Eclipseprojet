...
( 1, 'Mémo n°1', 'Texte du mémo n°1', TRUE ,4),
( 2, 'Mémo n°2', 'Texte du mémo n°2', FALSE ,3),
( 3, 'Mémo n°3', NULL, TRUE, NULL );
ALTER TABLE memo ALTER COLUMN idmemo RESTART WITH 4;

-- Service
INSERT INTO service (idservice,nom, annee, flagsiege,idpersonne ) VALUES
( 1, 'service n°1', 2002,TRUE, 2),
( 2, 'service n°2',2003, FALSE,3 ),
( 3, 'service n°3', 2006, TRUE,NULL );
